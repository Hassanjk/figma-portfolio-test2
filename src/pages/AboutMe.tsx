    ...
    <div className="relative w-full h-screen overflow-hidden bg-white text-black">
      ...
      <div className="container mx-auto px-4 pt-12 relative z-10">
        <div className="max-w-4xl mx-auto">
          <h1 className="hero-title text-7xl md:text-8xl mb-12 text-[#FF8A3C]" data-parallax="10">
            About Me
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 mt-16">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold font-unbounded text-[#FF8A3C]">Experience</h3>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold font-unbounded text-[#FF8A3C]">Skills</h3>
                <div className="flex flex-wrap gap-3">
                  {['UI Design', 'UX Design', 'Prototyping', 'User Research', 'Figma', 'React', 'TypeScript', 'Motion Design'].map((skill) => (
                    <span key={skill} className="px-4 py-2 bg-[#f5f5f5] rounded-full text-sm">
                      {skill}
                    </span>
                  ))}
                </div>
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold font-unbounded text-[#FF8A3C]">Connect</h3>
                <div className="flex gap-6">
                  <a href="#" className="hover:text-[#FF8A3C] transition-colors"><Github /></a>
                  <a href="#" className="hover:text-[#FF8A3C] transition-colors"><Linkedin /></a>
                  <a href="#" className="hover:text-[#FF8A3C] transition-colors"><Twitter /></a>
                  <a href="#" className="hover:text-[#FF8A3C] transition-colors"><Mail /></a>
                </div>
              </div>
            </div>
          </div>
